...
function Section() {
  ...
  return (
    <div className="section">
      <div className="book">
        <img className="photo" src={users.data.list[0].thumbnailUrl} alt="" />
        <h4 className="booktitle">{users.data.list[0].titleStatement}</h4>
      </div>
      <div className="book">
        <img className="photo" src="img/홍길동.jpg" alt=""></img>
