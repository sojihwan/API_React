...
function Section() {
  ...
  return (
    <div id="section">
      <div>
        <img className="photo" src={api.data.list[0].thumbnailUrl} />
        <img className="photo" src={api.data.list[1].thumbnailUrl} />
        <img className="photo" src={api.data.list[2].thumbnailUrl} />
        <img className="photo" src={api.data.list[6].thumbnailUrl} />
      </div>
    </div>
    // <div id="section">
