  ...
  return (
    <div id="section">
      <ul class="list_type">
        <li>
          <span class="thumb">
            <img src={api.data.list[0].thumbnailUrl} alt="" />
          </span>
          <em>{api.data.list[0].titleStatement}</em>
        </li>
        <li>
          <span class="thumb">
            <img src={api.data.list[6].thumbnailUrl} alt="" />
          </span>
          <em>{api.data.list[6].titleStatement}</em>
        </li>
      </ul>
    </div>
    // <div id="section">
